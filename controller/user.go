...
func ManageUser(c *gin.Context) {
	...
	case "add_quota":
		...
		case "add":
			...
			model.RecordLogWithAdminInfoAndQuota(user.Id, model.LogTypeManage, req.Value,
		...
		case "override":
			...
			model.RecordLogWithAdminInfoAndQuota(user.Id, model.LogTypeManage, req.Value-oldQuota,
